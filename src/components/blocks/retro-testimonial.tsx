				...
				{isExpanded && (
					<div className="fixed inset-0 h-screen overflow-hidden z-50">
						...
						<motion.div
							...
							className="max-w-none mx-auto bg-card border h-full z-[60] p-4 md:p-10 rounded-3xl relative md:mt-10"
						>
							<button
								className="sticky top-4 h-8 w-8 right-0 ml-auto rounded-full flex items-center justify-center bg-primary hover:bg-primary/80 transition-colors"
							...
							<motion.p
								...
								className="px-0 md:px-20 text-muted-foreground text-lg font-thin font-serif underline underline-offset-8"
							>
								{testimonial.designation}
							</motion.p>
							<motion.p
								layoutId={layout ? `title-${testimonial.name}` : undefined}
								className="px-0 md:px-20 text-2xl md:text-4xl font-normal italic text-foreground mt-4 font-serif lowercase"
							>
								{testimonial.name}
							</motion.p>
							<div className="py-8 text-foreground px-0 md:px-20 text-3xl lowercase font-thin font-serif leading-snug tracking-wide">
